...
default_alphabet = "zus bat cycle dick each fine gust hotel shit jury kapot look made near odd pit queue reason speed trap echo vest whale plex yank zeker".split(
    " "
)
